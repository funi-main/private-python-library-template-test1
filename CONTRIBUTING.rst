...
Set up your development environment with::
    ...
    git clone git@github.com:funi-main/private-python-library-template-test1.git
    cd private-python-library-template-test1
    make setup
...
``https://private-python-library-template-test1.readthedocs.io/``.
